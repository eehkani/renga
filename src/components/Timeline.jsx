...
const Timeline = () => {
    ...
    const [comments, setComments] = useState([{username: "Kazuma", userId: "K_azuma",txt: "柿食えば 鐘が鳴るなり 法隆寺", rep: []}])
    ...
    const handleComments = () => {
        ...
        if(username && userId && txt.trim()){
            const newComment = {username: username, userId: userId, txt: txt, rep: []}
    ...
    return(
        <>
            ...
            <div className="timeline_postWrapper">
                ...
                <input className="timeline_post" type="text" placeholder="user ID" value={userId} onChange={e=> setUserId(e.target.value)}/>
